...
public class AncientPedestalBlockEntityRenderer implements BlockEntityRenderer<AncientPedestalBlockEntity> {
    public AncientPedestalBlockEntityRenderer(BlockEntityRendererFactory.Context context){

    }
    @Override
    public void render(AncientPedestalBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
